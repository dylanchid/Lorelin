...
export function PreAuthModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-[1000px] max-h-[90vh] overflow-auto bg-[#f5f5f7] rounded-lg shadow-xl">
        <div className="bg-white border border-gray-200 rounded-lg m-6">
          <div className="px-8 py-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  onClick={onClose}
                  className="size-6 flex items-center justify-center text-[#6a7282] hover:text-[#101828] transition-colors"
                >
                  <X className="size-4" />
                </button>
              </div>
              ...
              {currentResult ? (
                <>
                  ...
                  {currentResult.status === 'pending' && (
                    <div className="flex items-start gap-3 px-4 py-3 bg-blue-50 border border-blue-200 rounded-lg mb-6">
                ...
                <div className="py-12 text-center">
                  ...
                  <h3 className="text-[14px] font-medium text-[#101828] mb-1">No request submitted yet</h3>
